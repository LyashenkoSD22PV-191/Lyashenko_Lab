...
public class User {
    ...
    private Integer calculateCreditRate(Integer monthIncome) {
        ...
        if (monthIncome >= 1000 && monthIncome < 2000) {
            return 200;
        }
        if (monthIncome >= 2000 && monthIncome < 3000) {
            return 300;
        }
        if (monthIncome >= 3000 && monthIncome < 4000) {
            return 400;
        }
        if (monthIncome >= 4000 && monthIncome < 5000) {
            return 500;
        }
        if (monthIncome >= 5000 && monthIncome < 6000) {
            return 600;
        }
        if (monthIncome >= 6000 && monthIncome < 7000) {
            return 700;
        }
        if (monthIncome >= 7000 && monthIncome < 8000) {
            return 800;
        }
        if (monthIncome >= 8000 && monthIncome < 9000) {
            return 900;
        }
        return 1000;
    }
